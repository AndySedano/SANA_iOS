...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    enum QuickActionType: String{
        ...
        case buscar = "force.touch.buscar"
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "mx.itesm.SANA_iOS" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SANA_iOS", withExtension: "momd")!
