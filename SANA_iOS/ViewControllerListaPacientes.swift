...
class ViewControllerListaPacientes: UITableViewController {
    private let datos = [
        "Juan Perez","Pablo Villaseñor","Andrea Ramirez","Fernanda Hernandez","Christian Lopez"
    ]
    ...
    */
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        destino.detalle = cell.textLabel!.text!
